            ...
            <div class="row">
                <div class="col-xxl-8 col-lg-7">
                    <div class="th-blog blog-single">
                        <div class="blog-img">
                            <img src="assets/img/blog/blog-s-1-1.jpg" alt="Image">
                        </div>
                        <div class="blog-content">
                            ...
                            <div class="row gx-30 mt-30 mb-34">
                                <div class="col-md-6 mb-30">
                                    <div>
                                        <img class="w-100 rounded-10" src="assets/img/blog/blog_inner_1.jpg" alt="Image">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-30">
                                    <div>
                                        <img class="w-100 rounded-10" src="assets/img/blog/blog_inner_2.jpg" alt="Image">
                                    </div>
                                </div>
                            </div>
